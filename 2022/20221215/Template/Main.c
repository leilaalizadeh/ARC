...
extern uint32_t addFPpositiveNumbers(float X,float Y);

int main(){
	  SystemInit();
		LED_init();
	
		//uint32_t result = addFPpositiveNumbers(0x424B0000,0x41A40000);
		uint32_t result = addFPpositiveNumbers(87.529,528.7);
	  if(result> 3.1415)
			LED_On(11-4);
    else 
			LED_Out(11-5);
